...
{
	/**
	 * Tests if `RegularExpressionInterface::match()` throws a `CodeKandis\RegularExpression\InvalidOffsetExceptionInterface` on an invalid offset.
	...
	public function testIfMethodMatchThrowsInvalidOffsetExceptionInterfaceOnInvalidOffset( RegularExpressionInterface $regularExpression, string $subject, int $validFlags, int $invalidOffset, string $expectedThrowableClassName, string $expectedThrowableMessage ): void
	{
		try
		{
		...
		{
			static::assertInstanceOf( InvalidOffsetExceptionInterface::class, $throwable );
	...
	/**
	 * Tests if `RegularExpressionInterface::matchAll()` throws a `CodeKandis\RegularExpression\InvalidOffsetExceptionInterface` on an invalid offset.
	 * @param RegularExpressionInterface $regularExpression The regular expression to test.
	 * @param string $subject The subject to pass.
	 * @param int $validFlags The valid search options to pass.
	 * @param int $invalidOffset The invalid offset to pass.
	 ...
	 */
	#[DataProviderExternal( RegularExpressionsWithSubjectValidFlagsInvalidOffsetExpectedThrowableClassNameAndExpectedThrowableMessageDataProvider::class, 'provideData' )]
	public function testIfMethodMatchAllThrowsInvalidOffsetExceptionInterfaceOnInvalidOffset( RegularExpressionInterface $regularExpression, string $subject, int $validFlags, int $invalidOffset, string $expectedThrowableClassName, string $expectedThrowableMessage ): void
	{
		try
		{
