	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedThrowableClassName' => InvalidOffsetException::class,
				'expectedThrowableMessage'   => sprintf( InvalidOffsetException::EXCEPTION_MESSAGE_INVALID_OFFSET, $invalidOffset, ValidValues::SIMPLE_SUBJECT_LENGTH * -1, ValidValues::SIMPLE_SUBJECT_LENGTH )
			],
			1 => [
				'regularExpression'          => new RegularExpression( $regularExpression = ValidValues::SIMPLE_GROUPED_REGULAR_EXPRESSION ),
				'subject'                    => ValidValues::SIMPLE_SUBJECT,
